...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            return _us.Register(email, password);
        }
        ...
        {
            return _us.Login(email, password);
        }
        ...
        {
            return _bs.LimitColumn(email, boardName, columnOrdinal, limit);
        }
        ...
        {
            return _bs.GetColumnLimit(email, boardName, columnOrdinal);
        }
        ...
        {
            return _bs.GetColumnName(email, boardName, columnOrdinal);
        }
        ...
        {
            return _bs.AddTask(email, boardName, title, description,dueDate);
        }
        ...
        {
            return _ts.UpdateTaskDueDate(email, boardName,columnOrdinal, taskId,dueDate);
        }
        ...
        {
            return _ts.UpdateTaskTitle(email, boardName,columnOrdinal, taskId, title);
        }
        ...
        {
            return _ts.UpdateTaskDescription(email, boardName,columnOrdinal, taskId, description);
        }
        ...
        {
            return _bs.AdvanceTask(email, boardName,columnOrdinal, taskId);
        }
        ...
        {
            return _bs.GetColumn(email, boardName,columnOrdinal);
        }
        ...
        {
            return _bs.AddBoard(email, name);
        }
        ...
        {
            return _bs.RemoveBoard(email, name);
        }
        ...
        {
            return _bs.InProgressTasks(email);
        }
        ...
        {
            return _bs.GetUserBoards(email);
        }
        ...
        {
            return _bs.JoinBoard(email,boardID);
        }
        ...
        {
            return _bs.LeaveBoard(email,boardID);
        }
        ...
        {
            return _bs.AssignTask(email,boardName,columnOrdinal,taskID,emailAssignee);
        }
        ...
        {
            return _dataService.DeleteData();
        }
        ...
        {
            return _bs.TransferOwnership(currentOwnerEmail,newOwnerEmail,boardName);
        }
    }
}
